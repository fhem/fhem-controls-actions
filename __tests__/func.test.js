...
test('gen controls content for pm file', () => {
  ...
  expect(data).not.toContain('UPD 2021-01-05_22:17:34 33     ./__tests__/mock.pm.bck')
...
test('gen controls content for pm and pm.bck file', () => {
  ...
  expect(data).toContain('UPD 2020-12-30_03:02:16 33     ./__tests__/mock.pm')
  expect(data).toContain('UPD 2021-01-05_22:17:34 33     ./__tests__/mock.pm.bck')
  //console.log(data);
});
...
test('gen controls content for inexistent extension', () => {
  ...
  expect(data).not.toContain('UPD 2020-12-30_03:02:16 33     ./__tests__/mock.ol')
  //console.log(data);
});
